 ...
 * @author marcelo_piva
 */
public class RetiradaChave extends javax.swing.JFrame {

    /**
     * Creates new form RetiradaChave
     */
    public RetiradaChave() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiradaChave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiradaChave().setVisible(true);
            }
        });
    }
